        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I Develop Software and Hardware for Robots, Drones and Mechatronic Systems.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Drone Programming</div>
                <div className="what-tags">Computer Vision</div>
                <div className="what-tags">Web Dashboard</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I Design Electronic Circuits, PCBs, and 3D Models for Robots, Drones and Mechatronic Systems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">PCB Design</div>
                <div className="what-tags">Embedded Software</div>
                <div className="what-tags">MATLAB</div>
                <div className="what-tags">Fusion360</div>
